...
function sentiment(text) {
  ...
  var positives = matchText(positiveWords, wordList);
  var negatives = matchText(negativeWords, wordList);
  var sentiment;
...
function matchText(matchArray, sanitizedText) {
  return sanitizedText.filter(function(word) {
    return matchArray.includes(word);
  });
}
